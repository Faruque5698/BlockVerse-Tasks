...
Route::middleware('auth:api')->group( function () {
    ...
    Route::get('/articles/own', [ArticleController::class, 'ownArticle'])->name('articles.ownArticle')->middleware('check.permission:view_own_articles');
    Route::get('/articles/publish/{id}', [ArticleController::class, 'publish'])->name('articles.publish')->middleware('check.permission:publish_article');
    ...
    Route::delete('/articles/{id}', [ArticleController::class, 'destroy'])->name('articles.destroy')->middleware('check.permission:delete-article');
});
